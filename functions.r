...
# replacing RGA with googleAnalyticsR
# library(RGA)
...
#                 date_range = c("2019-03-01", "2019-05-15"),
#                 metrics = "sessions",
...
get_ga_data <- function(profileID,
  ...
  ga_data <- google_analytics(viewId = profileID,
                              date_range = fetch_daterange,
                              metrics = fetch_metrics,
                              dimensions = fetch_dimensions,
                              filtersExpression = fetch_filter)
